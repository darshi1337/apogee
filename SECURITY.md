...
- Use GitHub’s [private vulnerability reporting](https://github.com/darshi1337/apogee/security/advisories/new) (Security tab, then "Report a vulnerability"), which is preferred
