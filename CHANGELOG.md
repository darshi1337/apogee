...
* Remove footer wordmark overlay from popup ([36fc9ed](https://github.com/darshi1337/apogee/commit/36fc9edaf0022a5902bccaea097295be32885197))
* Remove footer wordmark overlay from popup ([aa21044](https://github.com/darshi1337/apogee/commit/aa21044074af476a89344a08fde667b63b58cd14))

## [0.2.2](https://github.com/darshi1337/apogee/compare/v0.2.1...v0.2.2) (2026-09-21)
...
* **i18n:** Localize popup via chrome.i18n framework ([e8e1e07](https://github.com/darshi1337/apogee/commit/e8e1e07b320fa5eff1c98f6026eea15487b2de24))
* **i18n:** Localize popup via chrome.i18n framework ([6780eb7](https://github.com/darshi1337/apogee/commit/6780eb7bf681182894c6292833f92440d31955e7)), closes [#247](https://github.com/darshi1337/apogee/issues/247)
...
* **summarize:** Add per-page focus keyword ([a590c4a](https://github.com/darshi1337/apogee/commit/a590c4a2ddf3a5fdca2957f4e0ec3e038a2042f6))
* **summarize:** Add per-page focus keyword ([#161](https://github.com/darshi1337/apogee/issues/161)) ([1560098](https://github.com/darshi1337/apogee/commit/1560098b6711315a3105949fc3ec06d697287eee))
...
* Bundle pixel-dissolve.svg in extension and cache highlight text index ([740f7ba](https://github.com/darshi1337/apogee/commit/740f7bab341fa5a2dfa940ccf6c87d148849dcfd))
...
* **context-menus:** Restore eager setup plus onStartup, use shared IDs ([898c81b](https://github.com/darshi1337/apogee/commit/898c81b838543705d601ce45446324bb72e75f84))
* **deps:** Bump adm-zip override to 0.6.1 for GHSA-7q85-xj36-vmfc ([6821665](https://github.com/darshi1337/apogee/commit/6821665916ad7c04b3e9eb0ec944af27a0bdd053))
...
* **extract:** Add timeout auto-teardown and re-entry cleanup for selection capture ([becf4e7](https://github.com/darshi1337/apogee/commit/becf4e70e221a639fac31a938ff515e414d7d3ae))
* **extract:** Add timeout auto-teardown and re-entry cleanup for selection capture ([8906cfe](https://github.com/darshi1337/apogee/commit/8906cfe5d767e8c6099f85cbf35cde8c5fcd1e7b))
* **extract:** Cover happy-path capture and bound re-entry timer ([820b794](https://github.com/darshi1337/apogee/commit/820b7941903e218de3ef7579b0a4b96388cf4918))
* **extract:** Format selection test with prettier ([95fe713](https://github.com/darshi1337/apogee/commit/95fe713ecf163fbb5cf9d5c436a74f08ff69dd29))
* **extractors:** Handle extractor failures and URL variants ([#309](https://github.com/darshi1337/apogee/issues/309)) ([842c5d7](https://github.com/darshi1337/apogee/commit/842c5d7a84c208809b5ff8bce7d2ca7e1acfad56))
...
* **permissions:** Gate extraction on denial, distinguish lookup failures ([#304](https://github.com/darshi1337/apogee/issues/304), [#306](https://github.com/darshi1337/apogee/issues/306)) ([b7bbb85](https://github.com/darshi1337/apogee/commit/b7bbb859ae8e1d4408f43b37b297a3914feba07b))
* **permissions:** Gate extraction on denial, distinguish lookup failures ([#304](https://github.com/darshi1337/apogee/issues/304), [#306](https://github.com/darshi1337/apogee/issues/306)) ([16b4459](https://github.com/darshi1337/apogee/commit/16b445905d8848e72b2f71903703b86aee71cb2e))
...
* **popup:** Defrag-style segmented download progress ([#316](https://github.com/darshi1337/apogee/issues/316)) ([d45251a](https://github.com/darshi1337/apogee/commit/d45251ad2d8eba1a9ab8a06dfd2fd71138a377ed))
* **popup:** Empty-state wordmark and bulk JSON export ([#310](https://github.com/darshi1337/apogee/issues/310)) ([7142af0](https://github.com/darshi1337/apogee/commit/7142af07c1de5ad11e178e03b3e6753379e7fb97))
...
* **side-panel:** Sync panel on tab switch, retry extraction with one-site grant, inline extractor chip ([33f0e62](https://github.com/darshi1337/apogee/commit/33f0e626e052ce8e6dbc23382ab166317f5b9975))
